...
//DeepLink = Linking = abre aplicativos do celular, como Whatsapp
...
export default function Detail(){
    ...
    const incident = route.params.incident;  //pega o parametro passado na funcao
    ...
    function sendWhatsapp(){
        Linking.openURL(`whatsapp://send?phone=553186350857&text=${message}`);
